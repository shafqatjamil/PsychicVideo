...
import avreye.mytarotadvisor.adapter.ChatActivityAdapter;
...
import static avreye.mytarotadvisor.R.id.imageView;
...
public class ChatActivity extends AppCompatActivity {
    ...
    LinearLayout linearLayout_Client;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linearLayout_Advisor = (LinearLayout) findViewById(R.id.from_advisor);
        linearLayout_Client = (LinearLayout) findViewById(R.id.form);
        ...
        {
            linearLayout_Advisor.setVisibility(View.VISIBLE);
            linearLayout_Client.setVisibility(View.GONE);
            editText_advisor_message = (EditText) findViewById(R.id.edittext_from_advisor);
            editText_advisor_message.requestFocus();
        }
        else
        {
            linearLayout_Advisor.setVisibility(View.GONE);
        ...
        chatActivityAdapter = new ChatActivityAdapter(this,messages,AdvisorID,userSession.getUserId());
        assert messageList != null;
        messageList.setAdapter(chatActivityAdapter);
        messageList.setSelection(chatActivityAdapter.getCount() - 1);
        ...
        button_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ChatActivity.this,"Please write question and situation",Toast.LENGTH_SHORT).show();
                }
                else if(Integer.parseInt(userSession.getUserCredits()) < 150 && userSession.getUserType().contains("client"))
                {
                    Intent intent = new Intent(ChatActivity.this, CreditsActivity.class);
        ...
        imageButoon_Send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(ChatActivity.this,"Please write text reply or attach video reply",Toast.LENGTH_SHORT).show();
                }
                else {
                    send_message();
                }
    ...
    void send_message()
    {
        ...
        payload.setVideoUrl(ChatActivity.VideoName);
        ...
        chatActivityAdapter.SetMessagesArrayList(messages);
        ...
        Callback callback = new Callback() {
            public void successCallback(String channel, Object response) {
                ...
                Appboy.getInstance(ChatActivity.this).logCustomEvent(AdvisorName+"_TextOrder"+"_Placed");
    ...
    protected void onPause() {
        ...
        LocalBroadcastManager.getInstance(ChatActivity.this).unregisterReceiver(mMessageReceiver);
    }
        ...
        APICall.enqueue(new retrofit2.Callback<GetAdvisorStatusReponse>() {
            ...
            public void onResponse(Call<GetAdvisorStatusReponse> call, Response<GetAdvisorStatusReponse> response) {
                if (response.body() != null) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(ChatActivity.this,"Error occourd while getting status",Toast.LENGTH_SHORT).show();
                }
            }
            @Override
...
//            throw new RuntimeException("Unable to create save directory, make sure WRITE_EXTERNAL_STORAGE permission is granted.");
        ...
        new MaterialCamera(ChatActivity.this)                               // Constructor takes an Activity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            if (requestCode == REQUEST_VIDEO_CAPTURE) {
                ...
                Log.e("video path", getPath(ChatActivity.this, videoUri));
                file = new File(getPath(ChatActivity.this, videoUri));
                Log.e("Client Send Message", "send activty result called");
                ChatActivity.MessageType = "video";
            }
            ...
            if (requestCode == CAMERA_RQ) {
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    progressDialog.show();
                        ChatActivity.S3Example s3Example = new ChatActivity.S3Example();
                        s3Example.execute();
    ...
    private class S3Example extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            ChatActivity.VideoName = Constants.BUCKET_URL + "sjk" + mydate + ".mp4";
